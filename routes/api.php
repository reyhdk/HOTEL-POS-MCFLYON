    ...
    Route::middleware('role:admin')->group(function () {
       ...
       Route::patch('/online-orders/{order}/status', [AdminOrderController::class, 'updateStatus']); // <-- TAMBAHKAN INI
        ...
        Route::prefix('master')->group(function () {
            Route::apiResource('users', UserController::class)->scoped(['user' => 'uuid'])->middleware('can:master-user');
            Route::apiResource('roles', RoleController::class)->middleware('can:master-role');
        });
    });
});
