...
export default defineComponent({
    ...
    setup(props) {
        ...
        queryKey: [props.queryKey || props.url, page, per, debouncedSearch, props.payload], // Disarankan menambahkan variabel reaktif ke queryKey
    
    // ================= UBAH BAGIAN INI =================
        queryFn: () => axios.get(props.url, {        // 1. Ganti .post menjadi .get
            params: {                              // 2. Bungkus semua data di dalam object 'params'
                search: search.value,
                page: page.value,
